...
//    public static final String searchKeyWord2 = "challenges";
    ...
    public static final String Doc1 = "the brown fox jumped over the brown dog";
    public static final String Doc2 = "the lazy brown dog sat in the corner";
    public static final String Doc3 = "the red fox bit the lazy dog";

    public static final String searchKeyWord1 = "brown";
    public static final String searchKeyWord2 = "fox";
